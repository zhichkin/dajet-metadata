namespace DaJet
{
    ...
    public sealed class InfoBase
    {
        ...
        private static Dictionary<Guid, Guid[]> CreateMetadataRegistry()
        {
            return new(14)
            {
                { MetadataType.SharedProperty,       null }, // Общие реквизиты
                { MetadataType.Publication,          null }, // Планы обмена
                { MetadataType.DefinedType,          null }, // Определяемые типы
                { MetadataType.Constant,             null }, // Константы
                { MetadataType.Catalog,              null }, // Справочники
                { MetadataType.Document,             null }, // Документы
                { MetadataType.Enumeration,          null }, // Перечисления
                { MetadataType.Characteristic,       null }, // Планы видов характеристик
                { MetadataType.Account,              null }, // Планы счетов
                { MetadataType.InformationRegister,  null }, // Регистры сведений
                { MetadataType.AccumulationRegister, null }, // Регистры накопления
                { MetadataType.AccountingRegister,   null }, // Регистры бухгалтерии
                { MetadataType.BusinessProcess,      null }, // Бизнес-процесс

...
namespace DaJet.Json
{
    public sealed class DataObjectJsonConverter : JsonConverter<DataObject>
    {
        public override void Write(Utf8JsonWriter writer, DataObject record, JsonSerializerOptions options)
        {
            ...
            foreach (KeyValuePair<string, object> property in record)
            {
                name = property.Key;
                ...
                else if (value is List<bool> array)
                {
        ...
        private void WriteDateTime(Utf8JsonWriter writer, DateTime value)
        {
            writer.WriteStartObject();
            writer.WriteString("type", "datetime");
            writer.WriteString("value", value.ToString("yyyy-MM-ddTHH:mm:ss"));
            writer.WriteEndObject();
        }
        private void WriteBinary(Utf8JsonWriter writer, byte[] value)
        {
            writer.WriteStartObject();
            writer.WriteString("type", "binary");
        ...
        private void WriteUuid(Utf8JsonWriter writer, Guid value)
        {
            writer.WriteStartObject();
        ...
        private void WriteEntity(Utf8JsonWriter writer, Entity value)
        {
            writer.WriteStartObject();
        ...
        private void WriteUnion(Utf8JsonWriter writer, Union value)
        {
            // ?!
            writer.WriteStartObject();
            writer.WriteString("type", "entity");
